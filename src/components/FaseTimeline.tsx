...
const styles = StyleSheet.create({
  ...
  check: { color: '#111827', fontSize: 15, fontWeight: 'bold' },
  num: { color: colors.textMuted, fontSize: 14, fontWeight: 'bold' },
  info: { flex: 1 },
  label: { color: colors.text, fontSize: 16 },
  labelAtual: { color: colors.active, fontWeight: 'bold' },
  data: { color: colors.textMuted, fontSize: 13, marginTop: 2 },
});
