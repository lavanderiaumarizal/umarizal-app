...
const styles = StyleSheet.create({
  ...
  cliente: { color: colors.text, fontSize: 17, fontWeight: 'bold', marginTop: 4 },
  itens: { color: colors.textSecondary, fontSize: 14, marginTop: 4 },
  toque: { color: colors.primary, fontSize: 14, fontWeight: '600', marginTop: 10 },
});
