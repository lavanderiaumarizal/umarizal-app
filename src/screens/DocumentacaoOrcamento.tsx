...
const styles = StyleSheet.create({
  ...
  codigo: { color: colors.active, fontSize: 18, fontWeight: 'bold' },
  cliente: { color: colors.text, fontSize: 17, fontWeight: 'bold', marginTop: 2 },
  secao: { color: colors.textSecondary, fontSize: 15, marginTop: 16, marginBottom: 10 },
  card: {
  ...
  itemNome: { color: colors.text, fontSize: 16, fontWeight: 'bold' },
  itemMedidas: { color: colors.textSecondary, fontSize: 14, marginTop: 2 },
  ...
  removerText: { color: '#fff', fontSize: 14, fontWeight: 'bold' },
  addFoto: {
    width: 72,
    height: 72,
    borderRadius: 8,
  ...
  addFotoText: { color: colors.primary, fontSize: 32, fontWeight: 'bold' },
  fotoContador: { color: colors.textMuted, fontSize: 13, marginTop: 6 },
  confirmar: {
  ...
  confirmarText: { color: '#fff', fontWeight: 'bold', fontSize: 16 },
