...
const styles = StyleSheet.create({
  ...
  erro: { color: colors.danger, fontSize: 16, textAlign: 'center' },
  ...
  codigo: { color: colors.text, fontSize: 23, fontWeight: 'bold' },
  fase: { color: colors.textSecondary, fontSize: 14, marginTop: 4, textTransform: 'capitalize' },
  sectionTitle: { color: colors.text, fontSize: 17, fontWeight: 'bold', marginTop: 16, marginBottom: 8 },
  ...
  clienteNome: { color: colors.text, fontSize: 18, fontWeight: 'bold' },
  clienteMeta: { color: colors.textSecondary, fontSize: 15, marginTop: 4, lineHeight: 21 },
  itemRow: { paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: colors.border },
  itemHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  itemNome: { color: colors.text, fontSize: 16, fontWeight: '600' },
  itemCategoria: { color: colors.textMuted, fontSize: 13 },
  itemMedidas: { color: colors.textMuted, fontSize: 14, marginTop: 3 },
  precoBox: {
  ...
  precoValor: { color: colors.brandGold, fontSize: 25, fontWeight: 'bold' },
  precoDetalhe: { color: colors.textSecondary, fontSize: 14, marginTop: 2, textTransform: 'capitalize' },
  acoes: { marginTop: 20, backgroundColor: colors.surface, borderRadius: 12, borderWidth: 1, borderColor: colors.border, padding: 14 },
  acoesTitle: { color: colors.text, fontSize: 16, fontWeight: 'bold', marginBottom: 12 },
  ...
  botaoRetornarText: { color: colors.textSecondary, fontWeight: 'bold', fontSize: 16 },
  ...
  modalSub: { color: colors.textSecondary, fontSize: 15, marginTop: 2, marginBottom: 12 },
  modalInput: {
  ...
  embalagemFotoTakenText: { color: colors.success, fontWeight: 'bold', fontSize: 14 },
  botaoCamera: {
    backgroundColor: colors.background,
    borderWidth: 1,
  ...
  botaoCameraText: { color: colors.primary, fontSize: 14, fontWeight: '600' },
});
