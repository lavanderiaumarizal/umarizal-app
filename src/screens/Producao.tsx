...
const styles = StyleSheet.create({
  ...
  secao: { color: colors.text, fontSize: 17, fontWeight: 'bold', marginBottom: 8 },
  secaoTop: { marginTop: 20 },
  vazio: { color: colors.textMuted, fontSize: 15, marginBottom: 12 },
  card: {
  ...
  etapaInfo: { color: colors.textMuted, fontSize: 14, marginTop: 2 },
  ...
  botaoAcaoText: { color: '#fff', fontWeight: 'bold', fontSize: 15 },
  ...
  modalStop: { color: colors.textSecondary, fontSize: 15, marginTop: 2 },
  modalEtapa: { color: colors.active, fontSize: 15, fontWeight: 'bold', marginTop: 4, marginBottom: 8 },
  obsInput: {
  ...
  fotoTakenText: { color: colors.success, fontWeight: 'bold', fontSize: 14 },
  botaoCamera: {
    backgroundColor: colors.background,
    borderWidth: 1,
