...
const styles = StyleSheet.create({
  ...
  sub: { color: colors.textSecondary, fontSize: 15, marginTop: 2, marginBottom: 8 },
  secao: { color: colors.text, fontSize: 17, fontWeight: 'bold', marginTop: 18, marginBottom: 8 },
  ...
  cardValue: { color: colors.text, fontSize: 23, fontWeight: 'bold' },
  cardLabel: { color: colors.textSecondary, fontSize: 14, marginTop: 2 },
  cardLinha: {
    flexDirection: 'row',
  ...
  linhaLabel: { color: colors.textSecondary, fontSize: 16 },
  linhaValor: { color: colors.brandGold, fontSize: 17, fontWeight: 'bold' },
});
