...
const styles = StyleSheet.create({
  ...
  dataTitulo: { color: colors.active, fontSize: 13, fontWeight: 'bold' },
  dataTexto: { color: colors.text, fontSize: 16, fontWeight: 'bold', marginTop: 2 },
  ...
  total: { color: colors.textSecondary, fontSize: 14, marginBottom: 10 },
  vazio: { color: colors.textMuted, fontSize: 15, textAlign: 'center', paddingVertical: 24 },
  card: {
    backgroundColor: colors.surface,
    borderRadius: 12,
    borderWidth: 1,
  ...
  cliente: { color: colors.text, fontSize: 17, fontWeight: 'bold' },
  servico: { color: colors.textSecondary, fontSize: 14, marginTop: 3, lineHeight: 20 },
  datas: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8 },
  dataLabel: { color: colors.textMuted, fontSize: 13 },
  carregadoInfo: { color: colors.warning, fontSize: 13, marginTop: 6, fontWeight: '600' },
  checkboxRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  checkboxCheck: { color: '#111827', fontSize: 16, fontWeight: 'bold' },
  checkboxLabel: { color: colors.textSecondary, fontSize: 15, fontWeight: 'bold' },
